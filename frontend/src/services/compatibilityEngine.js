/**
 * Nestera Roommate Compatibility Engine (React / Next.js)
...
export function parseRoommateDiet(str) {
...
export function parseRoommateSmoking(str) {
  const s = (str || '').toLowerCase();
...
export function parseRoommateCleanliness(str) {
  const s = (str || '').toLowerCase();
...
export function parseRoommateSleep(str) {
  const s = (str || '').toLowerCase();
...
export function parseRoommateBudget(r) {
...
export function parseRoommatePersonality(r) {
...
export function calculateCompatibility(userPrefs, roommate) {
